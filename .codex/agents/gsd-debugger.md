...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/sunven/github/rcmm/.codex
                  → checks /Users/sunven/github/rcmm/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/sunven/github/rcmm/.codex/get-shit-done
                  → writes to /Users/sunven/github/rcmm/.codex/get-shit-done/hooks/
...
@/Users/sunven/github/rcmm/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/sunven/github/rcmm/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
