...
@/Users/sunven/github/rcmm/.codex/get-shit-done/references/thinking-models-execution.md
...
**See @/Users/sunven/github/rcmm/.codex/get-shit-done/references/checkpoints.md**
...
```bash
node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/Users/sunven/github/rcmm/.codex/get-shit-done/templates/summary.md
...
node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
