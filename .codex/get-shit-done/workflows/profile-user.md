...
Key references:
- @/Users/sunven/github/rcmm/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/sunven/github/rcmm/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/sunven/github/rcmm/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.md" "/Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/Users/sunven/github/rcmm/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/sunven/github/rcmm/.codex/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/sunven/github/rcmm/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd-dev-preferences at /Users/sunven/github/rcmm/.codex/commands/gsd/dev-preferences.md"

**For AGENTS.md profile section (if selected):**

```bash
node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /Users/sunven/github/rcmm/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/sunven/github/rcmm/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/sunven/github/rcmm/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/sunven/github/rcmm/.codex/AGENTS.md
```
