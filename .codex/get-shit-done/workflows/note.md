...
- **Global scope**: `/Users/sunven/github/rcmm/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sunven/github/rcmm/.codex/notes/`)
...
2. Glob `/Users/sunven/github/rcmm/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sunven/github/rcmm/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sunven/github/rcmm/.codex/notes/` — works in any directory
