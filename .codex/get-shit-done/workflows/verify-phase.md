...
<required_reading>
@/Users/sunven/github/rcmm/.codex/get-shit-done/references/verification-patterns.md
@/Users/sunven/github/rcmm/.codex/get-shit-done/templates/verification-report.md
</required_reading>
...
```bash
INIT=$(node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE_ARG}")
...
```bash
node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${phase_number}"
...
```bash
node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap analyze
```
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${phase_number}" --raw)
```
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "/Users/sunven/github/rcmm/.codex/get-shit-done/bin/gsd-tools.cjs" verify key-links "$plan")
...
See /Users/sunven/github/rcmm/.codex/get-shit-done/templates/verification-report.md for complete template.
</step>
