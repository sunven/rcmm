...
Visit the [Releases page](https://github.com/sunven/rcmm/releases) to download the latest DMG file.

### Installation

1. Download `rcmm-x.x.x.dmg`
2. Open the DMG file
3. Drag rcmm.app to the Applications folder
4. On first run, right-click the app and select "Open" (because the app is unsigned)
